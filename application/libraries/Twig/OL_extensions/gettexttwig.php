...
class GettextTwig extends Twig_Extension {
    public function getTokenParsers () {
        return array( new GettextTwigTokenParser(), new _TwigTokenParser(), new NGettextTwigTokenParser(), new DGettextTwigTokenParser(), new DNGettextTwigTokenParser(), new DCGettextTwigTokenParser(), new DCNGettextTwigTokenParser(), );
    }
