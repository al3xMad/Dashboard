 ...
 * @version    SVN: $Id$
 */
class DCNGettextTwigTokenParser extends Twig_TokenParser {
    public function parse ( Twig_Token $token ) {
        ...
        return new DCNGettextTwigNode( $domain, $msgid1, $msgid2, $count, $category, $parameters, $lineno, $this->getTag() );
    }
